                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                Safe City provides a robust platform where users can seamlessly report accidents in real-time, enabling swift responses from emergency services. Additionally, its intuitive map-based interface empowers users to stay informed about ongoing incidents, enhancing situational awareness and promoting community safety.
                                </p>
                            </div>
...
For inquiries, reach us via Facebook at Safecity, shoot us an email at Safecity@gmail.com, or ring us at [091234456612]. We're here to assist you!
                                </p>
                            </div>
                        ...
                        <a href="https://www.facebook.com/safecity.in" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                <div class="h-16 w-16 flex items-center justify-center rounded-full">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">SafeCity News</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Safecity News is a community-driven hub and newsletter curating all the latest and vital updates within the Safecity ecosystem, featuring our Facebook page, new features, and community tutorials.                                </p>
                            </div>
                        ...
                        <a href="https://www.facebook.com/safecity.in" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">GitHub community</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Join the SafeCity GitHub community to collaborate on enhancing safety measures, developing innovative solutions, and contributing to the evolution of our city's security infrastructure.                                </p>
                            </div>
            </a>
                        </div>
                    </div>
